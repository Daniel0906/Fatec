...
public class JurosSimplesServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<p><b>Nome:</b> Daniel Amorim de Castro</p>");
            out.println("<p><b>RA:</b> 1290481922013</p>");
            out.println("<p>-------------------------------------------</p>");
            double vp = Double.parseDouble(request.getParameter("valorPresente"));
            double juros = Double.parseDouble(request.getParameter("juros"));
            double meses = Double.parseDouble(request.getParameter("meses"));
            double jurosR = juros / 100;
            double conta = vp*(1+jurosR*meses);
            out.println("Valor presente: " + vp);
            out.println("<br><br>");
            out.println("Juros (%): " + juros);
            out.println("<br><br>");
            out.println("Tempo (meses): " + meses);
            out.println("<br><br>");
            out.println("<b>Resultado (valor futuro):</b>" + conta);
            out.println("<br><br>");
